    ...
    C11.2,9.8,11.2,10.4,10.8,10.8z" />
            ...
            <div class="mobile-menu__panel">
                <div class="mobile-menu__panel-header">
                    <div class="mobile-menu__panel-title">TORKSKY</div>
                </div>
                    ...
                    <div class="mobile-menu__settings-list">
                        ...
                        <div class="mobile-menu__setting" data-mobile-menu-item>
                            <button class="mobile-menu__setting-button" title="Currency" data-mobile-menu-trigger>
                                ...
                                <span class="mobile-menu__setting-title">Rupee</span>
                                <span class="mobile-menu__setting-arrow"><svg width="6px" height="9px">
                                        <path d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z" />
                                    </svg>
                                </span>
    ...
    c-1.5,0-2.9,0.6-4,1.5C8.9,1.6,7.5,1,6,1C2.7,1,0,3.7,0,7c0,5,6,12,10,12s10-7,10-12C20,3.7,17.3,1,14,1L14,1z" />
                        ...
                        <a class="mobile-menu__indicator" href="{{ route("customer.dashboard") }}">
                            <span class="mobile-menu__indicator-icon">
                                <svg width="20" height="20">
    ...
    C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" />
                                ...
                                @auth
                                <span class="mobile-menu__indicator-counter">{{ Auth::user()->carts()->count() }}</span>
                                @else
    ...
    C15.5,10.2,14,11.3,14,12z" />
                            ...
                            <span class="mobile-menu__indicator-title">Dashboard</span>
                        </a>
                    </div>
                    <div class="mobile-menu__divider"></div>
                    <ul class="mobile-menu__links">
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                    ...
                    <a class="mobile-menu__contacts" href="">
                        <div class="mobile-menu__contacts-subtitle">Need Help? Call Us</div>
                        <div class="mobile-menu__contacts-title">+917599057867</div>
                    </a>
                </div>
            </div>
        </div>
