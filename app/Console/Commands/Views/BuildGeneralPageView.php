...
class BuildGeneralPageView extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:opview {path}';
     ...
     * @var string
     */
    protected $description = 'Building a operator general page view.';
    ...
    public function handle()
    {
        ...
        Artisan::call("make:view " . $path . ' --extends=templates.operator_gpage --section=title --section=page_title --section=page_content -n',[] , new StreamOutput($stream));        return $stream;
    }
}
